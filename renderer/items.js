...
// Get reaerJS content
let readerJS = fs.readFile(`${__dirname}/reader.js`, (error, data) => {
    readerJS = data.toString()
})

// Track item in storage
...
exports.open = () => {
    ...
    let readerWin = window.open(contentURL, '_blank', `
    maxWidth=2000,
    maxHeight=2000,
    width=1200,
    height=800,
...
exports.addItem = (item, isNew = false) => {
    ...
    // Assigne "read-item" class
    itemNode.setAttribute('class', 'read-item')

    // Set item url as data attribut
